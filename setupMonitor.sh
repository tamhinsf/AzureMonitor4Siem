...
printf '{\n "az_storage_account":"%s",\n "az_storage_account_container":"%s",\n "az_storage_account_sas":"%s", \n "az_event_hub_connection_string":"%s", \n "az_event_hub_name" : "%s", \n "az_local_logs_dir" : "" \n }\n' "$AZ_STORAGE_ACCOUNT" "$AZ_STORAGE_ACCOUNT_CONTAINER" "$AZ_STORAGE_ACCOUNT_SAS" "$AZ_EVENTHUB_CONNECTION_STRING" "insights-operational-logs" > localsettings.json